              ...
              <tfoot>
                <tr className="bg-muted/30 font-semibold">
                  ...
                  <td className="py-2 text-right text-green-600">
                    {formatCurrency(monthlyData.reduce((sum, d) => sum + d.devengado, 0))}
                  </td>
                  <td className="py-2 text-right text-red-600">
                    -{formatCurrency(monthlyData.reduce((sum, d) => sum + d.deducciones, 0))}
                  </td>
                  <td className="py-2 text-right text-blue-600">
                    {formatCurrency(monthlyData.reduce((sum, d) => sum + d.neto, 0))}
                  </td>
                </tr>
              </tfoot>
            </table>
